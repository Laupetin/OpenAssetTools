...
namespace
{
    class MenuWriter final : public menu::AbstractBaseWriter, public menu::IWriterIW6
    {
    public:
    ...
    private:
        ...
        void WriteDecodeEffectProperty(const std::string& propertyKey, const itemDef_t* item) const
        {
            if (!item->decayActive)
                return;
        ...
        void WriteListBoxProperties(const itemDef_t* item)
        {
        ...
        void WriteDvarFloatProperty(const std::string& propertyKey, const itemDef_t* item, const editFieldDef_s* editField) const
        {
        ...
        void WriteEditFieldProperties(const itemDef_t* item) const
        {
            switch (item->type)
            {
            case ITEM_TYPE_TEXT:
        ...
        void WriteMultiProperties(const itemDef_t* item) const
        {
        ...
        void WriteEnumDvarProperties(const itemDef_t* item) const
        {
        ...
        void WriteTickerProperties(const itemDef_t* item) const
        {
        ...
        void WriteItemData(const itemDef_t* item)
        {
        ...
        void WriteItemDefs(const itemDef_t* const* itemDefs, size_t itemCount)
        {
