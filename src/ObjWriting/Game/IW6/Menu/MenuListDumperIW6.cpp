#include "MenuListDumperIW6.h"

#include "Game/IW6/Menu/MenuWriterIW6.h"
...
namespace
{
    ...
    void DumpFunctions(menu::IWriterIW6& menuDumper, const MenuList* menuList)
    {
    ...
    void DumpMenus(menu::IWriterIW6& menuDumper, const MenuList* menuList)
    {
...
namespace menu
{
    void MenuListDumperIW6::DumpAsset(AssetDumpingContext& context, const XAssetInfo<AssetMenuList::Type>& asset)
    {
