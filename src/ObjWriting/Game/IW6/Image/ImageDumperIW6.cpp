...
namespace
{
    std::unique_ptr<Texture> LoadImageFromLoadDef(const GfxImage& image)
    {
        ...
        const auto& gfxTexture = image.texture;
...
namespace image
{
    ...
    void DumperIW6::DumpAsset(AssetDumpingContext& context, const XAssetInfo<AssetImage::Type>& asset)
    {
