...
{
    void DumperIW6::DumpAsset(AssetDumpingContext& context, const XAssetInfo<AssetSoundCurve::Type>& asset)
    {
        const auto* soundCurve = asset.Asset();
        const auto& sndCurve = soundCurve->curve;
