#include "FxImpactTableDumperIW5.h"

#include "CSV/CsvWriter.h"
#include "Utils/Logging/Log.h"

#include <Game/IW5/Fx/FxImpactTableConstantsIW5.h>
#include <format>
...
{
    void DumperIW5::DumpAsset(AssetDumpingContext& context, const XAssetInfo<FxImpactTable>& asset)
    {
