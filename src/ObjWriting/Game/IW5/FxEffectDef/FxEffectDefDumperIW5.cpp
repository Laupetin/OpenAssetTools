#include "FxEffectDefDumperIW5.h"
...
#include <Game/IW5/Fx/FxElemDefConstantsIW5.h>
#include <math.h>
...
{
    void DumperIW5::DumpAsset(AssetDumpingContext& context, const XAssetInfo<AssetFx::Type>& asset)
    {
