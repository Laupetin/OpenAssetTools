#include "FxImpactTableDumperT6.h"

#include "CSV/CsvWriter.h"
#include "Utils/Logging/Log.h"

#include <Game/T6/Fx/FxImpactTableConstantsT6.h>
#include <format>
...
{
    void DumperT6::DumpAsset(AssetDumpingContext& context, const XAssetInfo<FxImpactTable>& asset)
    {
