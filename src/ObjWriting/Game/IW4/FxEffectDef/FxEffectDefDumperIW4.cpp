#include "FxEffectDefDumperIW4.h"
...
#include <Game/IW4/Fx/FxElemDefConstantsIW4.h>
#include <math.h>
...
namespace
{
    ...
    void DumpFxElemDef(const FxElemDef* subAsset, const FxEffectDef& fxEffectDef, FxElemDefDumper& fxElemDefDumper, unsigned int defIndex)
    {
        ...
        FxElemDefAtlasBehavior atlasBehavior = subAsset->atlas.behavior;
        if (atlasBehavior.rawBehavior == 0)
        {
...
{
    void DumperIW4::DumpAsset(AssetDumpingContext& context, const XAssetInfo<AssetFx::Type>& asset)
    {
