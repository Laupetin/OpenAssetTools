#include "FxImpactTableDumperIW4.h"

#include "CSV/CsvWriter.h"
#include "Utils/Logging/Log.h"

#include <Game/IW4/Fx/FxImpactTableConstantsIW4.h>
#include <format>
...
{
    void DumperIW4::DumpAsset(AssetDumpingContext& context, const XAssetInfo<FxImpactTable>& asset)
    {
