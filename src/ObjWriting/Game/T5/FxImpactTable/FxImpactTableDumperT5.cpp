#include "FxImpactTableDumperT5.h"

#include "CSV/CsvWriter.h"
#include "Utils/Logging/Log.h"

#include <Game/T5/Fx/FxImpactTableConstantsT5.h>
#include <format>
...
{
    void DumperT5::DumpAsset(AssetDumpingContext& context, const XAssetInfo<FxImpactTable>& asset)
    {
