...
namespace T5
{
    ...
    inline constexpr std::array FX_FLAG_DEFS{
        ...
        FxFlagDef{"spawnRelativeType0",  FxFlagType::NATIVE, FX_ELEM_SPAWN_RELATIVE_TYPE_0,        FX_ELEM_SPAWN_RELATIVE_TYPE_0       },
        FxFlagDef{"spawnRelativeType1",  FxFlagType::NATIVE, FX_ELEM_SPAWN_RELATIVE_TYPE_1,        FX_ELEM_SPAWN_RELATIVE_TYPE_1       },
        FxFlagDef{"spawnRelativeType2",  FxFlagType::NATIVE, FX_ELEM_SPAWN_RELATIVE_TYPE_2,        FX_ELEM_SPAWN_RELATIVE_TYPE_2       },
        FxFlagDef{"spawnRelativeType4",  FxFlagType::NATIVE, FX_ELEM_SPAWN_RELATIVE_TYPE_4,        FX_ELEM_SPAWN_RELATIVE_TYPE_4       },
