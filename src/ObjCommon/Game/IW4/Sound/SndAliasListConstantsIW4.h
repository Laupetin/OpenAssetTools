...
namespace IW4
{
    ...
    static const char* snd_alias_channel_names[] = {
        "physics",         "ambdist1",     "ambdist2", "auto",      "auto2",          "autodog", "bulletimpact", "bulletwhizby",
        "explosiveimpact", "element",      "auto2d",   "vehicle",   "vehiclelimited", "menu",    "body",         "body2d",
        "reload",          "reload2d",     "item",     "effects1",  "effects2",       "weapon",  "weapon2d",     "nonshock",
        "voice",           "local",        "local2",   "local3",    "ambient",        "hurt",    "player1",      "player2",
        "music",           "musicnopause", "mission",  "announcer", "shellshock"};
