#include "ContentWriterIW6.h"

#include "Game/IW6/AssetWriterIW6.h"
...
#define SKIP_ASSET(type_index, typeName, headerEntry)                                                                                                          \
    ...
    switch (varXAsset->type)
    {
        ...
        WRITE_ASSET(ASSET_TYPE_SOUND_CURVE, SoundCurve, sndCurve)
        WRITE_ASSET(ASSET_TYPE_LPF_CURVE, LpfCurve, lpfCurve)
        WRITE_ASSET(ASSET_TYPE_REVERB_CURVE, ReverbCurve, reverbCurve)
