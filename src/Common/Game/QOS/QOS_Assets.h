...
namespace QOS
{
    ...
    static_assert(sizeof(PhysConstraint) == 68);
    static_assert(sizeof(PhysConstraints) == 1096);
    static_assert(sizeof(XAnimParts) == 92);
    static_assert(sizeof(DObjSkelMat) == 64);
    static_assert(sizeof(DObjAnimMat) == 32);
    static_assert(sizeof(XSurfaceTri) == 6);
    static_assert(sizeof(GfxPackedVertex) == 40);
    static_assert(sizeof(GfxPackedVertex16) == 16);
    static_assert(sizeof(XSurfaceVertexInfo) == 16);
    static_assert(sizeof(XRigidVertList) == 8);
    static_assert(sizeof(XSurface) == 80);
    static_assert(sizeof(XModelLodInfo) == 32);
    ...
    static_assert(sizeof(PhysGeomInfo) == 68);
    static_assert(sizeof(PhysGeomList) == 20);
    static_assert(sizeof(XModel) == 240);
    static_assert(sizeof(MaterialTextureDef) == 12);
    static_assert(sizeof(MaterialWaterDef) == 32);
    static_assert(sizeof(water_t) == 68);
    static_assert(sizeof(MaterialConstantDef) == 32);
    static_assert(sizeof(GfxStateBits) == 8);
    static_assert(sizeof(GfxImageLoadDef) == 20);
    ...
    static_assert(sizeof(cStaticModel_t) == 80);
    static_assert(sizeof(dmaterial_t) == 72);
    static_assert(sizeof(cNode_t) == 8);
    static_assert(sizeof(cLeaf_t) == 44);
    static_assert(sizeof(cLeafBrushNodeChildren_t) == 12);
    static_assert(sizeof(cLeafBrushNodeLeaf_t) == 4);
    static_assert(sizeof(cLeafBrushNodeData_t) == 12);
    static_assert(sizeof(cLeafBrushNode_s) == 20);
    static_assert(sizeof(CollisionBorder) == 28);
    static_assert(sizeof(CollisionPartition) == 20);
    static_assert(sizeof(CollisionAabbTree) == 32);
    static_assert(sizeof(cmodel_t) == 72);
    static_assert(sizeof(cbrush_t) == 80);
    static_assert(sizeof(DynEntityDef) == 88);
    static_assert(sizeof(DynEntityClient) == 52);
    static_assert(sizeof(DynEntityServer) == 36);
    static_assert(sizeof(DynEntityColl) == 32);
    static_assert(sizeof(DynEntityPhysConstraint) == 72);
    static_assert(sizeof(clipMap_t) == 324);
    static_assert(sizeof(ComPrimaryLight) == 68);
    static_assert(sizeof(ComWorldUnknownCell) == 36);
    static_assert(sizeof(ComWorld) == 44);
    static_assert(sizeof(pathnode_tree_nodes_t) == 8);
    static_assert(sizeof(pathnode_tree_t) == 16);
    static_assert(sizeof(pathbasenode_t) == 16);
    static_assert(sizeof(pathnode_transient_t) == 32);
    static_assert(sizeof(pathnode_dynamic_t) == 32);
    static_assert(sizeof(pathlink_s) == 12);
    static_assert(sizeof(pathnode_constant_t) == 68);
    static_assert(sizeof(pathnode_t) == 132);
    static_assert(sizeof(PathData) == 36);
    static_assert(sizeof(GameWorldSp) == 40);
    static_assert(sizeof(GameWorldMp) == 4);
    static_assert(sizeof(GfxWorldVertex) == 44);
    static_assert(sizeof(GfxWorldVertexData) == 8);
    static_assert(sizeof(GfxWorldVertexLayerData) == 8);
    static_assert(sizeof(GfxLight) == 68);
    static_assert(sizeof(GfxReflectionProbe) == 16);
    static_assert(sizeof(srfTriangles_t) == 16);
    ...
    static_assert(sizeof(GfxAabbTreeChildren) == 48);
    static_assert(sizeof(GfxPortal) == 68);
    static_assert(sizeof(GfxCell) == 52);
    static_assert(sizeof(GfxLightmapArray) == 8);
    static_assert(sizeof(GfxLightGridEntry) == 4);
    static_assert(sizeof(GfxLightGridColors) == 168);
    static_assert(sizeof(GfxLightGrid) == 52);
    static_assert(sizeof(GfxBrushModel) == 60);
    static_assert(sizeof(MaterialMemory) == 8);
    static_assert(sizeof(sunflare_t) == 96);
    static_assert(sizeof(GfxDrawSurf) == 8);
    static_assert(sizeof(GfxSceneDynModel) == 8);
    static_assert(sizeof(GfxSceneDynBrush) == 8);
    static_assert(sizeof(GfxDynEntCellRef) == 6);
    static_assert(sizeof(GfxShadowGeometry) == 12);
    static_assert(sizeof(GfxLightRegion) == 24);
    static_assert(sizeof(GfxWorld) == 728);
    static_assert(sizeof(GfxLightImage) == 8);
    static_assert(sizeof(GfxLightDef) == 16);
    static_assert(sizeof(Glyph) == 24);
    static_assert(sizeof(Font_s) == 24);
    static_assert(sizeof(MenuList) == 12);
    static_assert(sizeof(rectDef_s) == 24);
    static_assert(sizeof(windowDef_t) == 168);
    static_assert(sizeof(ItemKeyHandler) == 12);
    static_assert(sizeof(operandInternalDataUnion) == 4);
    static_assert(sizeof(Operand) == 8);
    static_assert(sizeof(entryInternalData) == 8);
    static_assert(sizeof(expressionEntry) == 12);
    static_assert(sizeof(statement_s) == 8);
    static_assert(sizeof(columnInfo_s) == 16);
    static_assert(sizeof(listBoxDef_s) == 364);
    static_assert(sizeof(editFieldDef_s) == 32);
    static_assert(sizeof(multiDef_s) == 392);
    static_assert(sizeof(itemDefData_t) == 4);
    static_assert(sizeof(itemDef_s) == 468);
    static_assert(sizeof(menuDef_t) == 308);
    static_assert(sizeof(SndCurve) == 72);
    static_assert(sizeof(QosMssSound) == 44);
    static_assert(sizeof(QosPrimedSound) == 12);
    static_assert(sizeof(SoundFile) == 200);
    static_assert(sizeof(snd_alias_t) == 80);
    static_assert(sizeof(snd_alias_list_t) == 12);
    static_assert(sizeof(LocalizeEntry) == 8);
    static_assert(sizeof(xmlAttribute) == 12);
    static_assert(sizeof(xmlNodeList) == 8);
    static_assert(sizeof(xmlAttribList) == 36);
    static_assert(sizeof(xmlNodeComplex) == 48);
    static_assert(sizeof(xmlNode) == 12);
    static_assert(sizeof(XmlTree) == 12);
    static_assert(sizeof(FxElemVelStateSample) == 96);
    static_assert(sizeof(FxElemVisStateSample) == 48);
    static_assert(sizeof(FxElemVisuals) == 4);
    static_assert(sizeof(FxElemMarkVisuals) == 8);
    static_assert(sizeof(FxElemDefVisuals) == 4);
    static_assert(sizeof(FxTrailVertex) == 20);
    static_assert(sizeof(FxTrailDef) == 28);
    static_assert(sizeof(FxElemDef) == 252);
    static_assert(sizeof(FxEffectDef) == 32);
    static_assert(sizeof(FxImpactEntry) == 136);
    static_assert(sizeof(FxImpactTable) == 8);
    static_assert(sizeof(snd_alias_list_name) == 4);
    static_assert(sizeof(SndAliasCustom) == 4);
    static_assert(sizeof(WeaponDef) == 2764);
    static_assert(sizeof(AnimReference) == 16);
    static_assert(sizeof(SceneAnimation) == 16);
    static_assert(sizeof(CutsceneModelAttachment) == 8);
    static_assert(sizeof(CutsceneEntityDef) == 28);
    static_assert(sizeof(CutsceneSectionDef) == 16);
    static_assert(sizeof(Cutscene) == 32);
    static_assert(sizeof(CustomCameraDef) == 116);
    static_assert(sizeof(CustomCamera) == 12);
    static_assert(sizeof(DestructibleModel) == 32);
    static_assert(sizeof(DestructiblePiece) == 196);
    static_assert(sizeof(DestructibleDef) == 16);
#endif
