...
namespace menu
{
    ...
    public:
        ...
        {
            return And({MatcherFactoryWrapper<SimpleParserValue>(std::make_unique<MenuMatcherScriptNumeric>())
                            .Transform(
        ...
        {
            return And({MatcherFactoryWrapper<SimpleParserValue>(std::make_unique<MenuMatcherScriptInt>())
                            .Transform(
                                [](const token_list_t& tokens) -> SimpleParserValue
                                {
                                    const auto& firstToken = tokens[0].get();
        ...
        {
            return Or({Type(SimpleParserValueType::STRING),
                       Type(SimpleParserValueType::IDENTIFIER),
                       Or({
                              Type(SimpleParserValueType::CHARACTER),
                              Type(SimpleParserValueType::FLOATING_POINT),
        ...
        {
            return And({ScriptStrictNumeric(), Optional(ScriptStrictNumeric()), Optional(ScriptStrictNumeric()), Optional(ScriptStrictNumeric())});
        }
...
namespace menu::event_handler_set_scope_sequences
{
    ...
    public:
        explicit SequenceGenericScriptStatement(std::initializer_list<Movable<std::unique_ptr<AbstractMatcher<SimpleParserValue>>>> matchers)
        {
            ...
            AddMatchers({create.And(matchers).Capture(CAPTURE_SCRIPT_TOKEN), create.Optional(create.Char(';'))});
        }
    ...
    public:
            ...
            : SequenceGenericScriptStatement()
        {
            ...
            AddMatchers(
                {create.And({create.ScriptKeyword("uiScript"), create.And(matchers)}).Capture(CAPTURE_SCRIPT_TOKEN), create.Optional(create.Char(';'))});
        }
    ...
    protected:
        ...
        {
            return create.Or({create.ScriptKeyword("false"),
        ...
        explicit SequenceSetPlayerData()
        {
            ...
            AddMatchers({create
                             .And({
                                 ...
                                 create.Loop(create.And({create.ScriptChar(','), create.Label(LABEL_PLAYER_DATA_PATH_ELEMENT)})),
                                 create.ScriptChar(')'),
                             })
                             .Capture(CAPTURE_SCRIPT_TOKEN),
    ...
    public:
        SequenceSetLocalVar()
        {
            ...
            AddMatchers({create.Or({create.ScriptKeyword("setLocalVarBool").Tag(TAG_BOOL),
    ...
    public:
        SequenceIf()
        {
            ...
            AddMatchers({create.Keyword("if").Capture(CAPTURE_KEYWORD),
                         create.Char('('),
                         create.Label(MenuExpressionMatchers::LABEL_EXPRESSION),
                         create.Char(')'),
                         create.Char('{')});
    ...
    public:
        SequenceElse()
        {
            ...
            AddMatchers({create.Char('}'), create.Keyword("else").Capture(CAPTURE_KEYWORD), create.Char('{')});
        }
    ...
    public:
        explicit SequenceOnlineVault()
        {
            ...
            AddLabeledMatchers(create.And({create.ScriptKeyword("open"),
            ...
            AddMatchers({create
                             .And({create.ScriptKeyword("uiScript"),
    ...
    if (!permissive)
    {
        ...
        AddSequence(SequenceGenericScriptStatement::Create(
            {create.ScriptKeyword("setColor"),
             ...
             create.ScriptColor()})); // setColor ("backColor" | "foreColor" | "borderColor") <r> [<g>] [<b>] [<a>]
        ...
        AddSequence(
            SequenceGenericScriptStatement::Create({create.ScriptKeyword("closeForAllPlayers"), create.ScriptText()}));    // closeForAllPlayers <menu name>
        ...
        AddSequence(SequenceGenericScriptStatement::Create(
            {create.ScriptKeyword("setItemColor"),
             create.ScriptText(),
             create.Or({create.ScriptKeyword("backColor"),
                        create.ScriptKeyword("foreColor"),
                        create.ScriptKeyword("borderColor"),
                        create.ScriptKeyword("disableColor")}),
             create.ScriptColor()})); // setItemColor <item group name> (backColor | foreColor | borderColor | disableColor) <r> [<g>] [<b>] [<a>]
        ...
        AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("execOnDvarStringValue"),
                                                            create.ScriptText(),
                                                            create.ScriptText(),
                                                            create.ScriptText()})); // execOnDvarStringValue <dvar name> <value> <command>
        AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("execOnDvarIntValue"),
                                                            create.ScriptText(),
                                                            create.ScriptInt(),
                                                            create.ScriptText()})); // execOnDvarIntValue <dvar name> <value> <command>
        AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("execOnDvarFloatValue"),
                                                            create.ScriptText(),
                                                            create.ScriptNumeric(),
                                                            create.ScriptText()})); // execOnDvarFloatValue <dvar name> <value> <command>
        AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("execNowOnDvarStringValue"),
                                                            create.ScriptText(),
                                                            create.ScriptText(),
                                                            create.ScriptText()})); // execNowOnDvarStringValue <dvar name> <value> <command>
        AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("execNowOnDvarIntValue"),
                                                            create.ScriptText(),
                                                            create.ScriptInt(),
                                                            create.ScriptText()})); // execNowOnDvarIntValue <dvar name> <value> <command>
        AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("execNowOnDvarFloatValue"),
                                                            create.ScriptText(),
                                                            create.ScriptNumeric(),
                                                            create.ScriptText()})); // execNowOnDvarFloatValue <dvar name> <value> <command>
        ...
        AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("scriptMenuRespondOnDvarStringValue"),
                                                            create.ScriptText(),
                                                            create.ScriptText(),
                                                            create.ScriptText()})); // scriptMenuRespondOnDvarStringValue <dvar name> <value> <response value>
        AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("scriptMenuRespondOnDvarIntValue"),
                                                            create.ScriptText(),
                                                            create.ScriptInt(),
                                                            create.ScriptText()})); // scriptMenuRespondOnDvarIntValue <dvar name> <value> <response value>
        AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("scriptMenuRespondOnDvarFloatValue"),
                                                            create.ScriptText(),
                                                            create.ScriptNumeric(),
                                                            create.ScriptText()})); // scriptMenuRespondOnDvarFloatValue <dvar name> <value> <response value>
        ...
        AddSequence(SequenceUiScriptStatement::Create({create.ScriptKeyword("openMenuOnDvar"),
                                                       create.ScriptText(),
                                                       create.Or({create.ScriptStrictNumeric(), create.ScriptText()}),
                                                       create.ScriptText()}));
        AddSequence(SequenceUiScriptStatement::Create({create.ScriptKeyword("openMenuOnDvarNot"),
                                                       create.ScriptText(),
                                                       create.Or({create.ScriptStrictNumeric(), create.ScriptText()}),
                                                       create.ScriptText()}));
        AddSequence(SequenceUiScriptStatement::Create({create.ScriptKeyword("closeMenuOnDvar"),
                                                       create.ScriptText(),
                                                       create.Or({create.ScriptStrictNumeric(), create.ScriptText()}),
                                                       create.ScriptText()}));
        AddSequence(SequenceUiScriptStatement::Create({create.ScriptKeyword("closeMenuOnDvarNot"),
                                                       create.ScriptText(),
                                                       create.Or({create.ScriptStrictNumeric(), create.ScriptText()}),
                                                       create.ScriptText()}));
        ...
        if (featureLevel == FeatureLevel::IW4)
        {
            ...
            AddSequence(
                SequenceGenericScriptStatement::Create({create.ScriptKeyword("setDvar"),
                                                        create.ScriptText(),
                                                        create.Or({create.ScriptStrictNumeric(), create.ScriptText()})})); // setDvar <dvar name> <dvar value>
            AddSequence(SequenceGenericScriptStatement::Create(
                {create.ScriptKeyword("scriptMenuResponse"), create.ScriptText()})); // scriptMenuResponse <response value>
        ...
        if (featureLevel == FeatureLevel::IW5)
        {
            ...
            AddSequence(SequenceGenericScriptStatement::Create(
                {create.ScriptKeyword("execKeyPress"), create.Or({create.ScriptStrictNumeric(), create.ScriptText()})})); // execKeyPress <key number>
            AddSequence(SequenceGenericScriptStatement::Create({
            ...
            AddSequence(
                SequenceGenericScriptStatement::Create({create.ScriptKeyword("feederBottom"), create.Optional(create.Text())})); // feederBottom [<var name>]
            AddSequence(
                SequenceGenericScriptStatement::Create({create.ScriptKeyword("feederPageUp"), create.Optional(create.Text())})); // feederPageUp [<var name>]
            AddSequence(SequenceGenericScriptStatement::Create(
                {create.ScriptKeyword("feederPageDown"), create.Optional(create.Text())}));                          // feederPageDown [<var name>]
            ...
            AddSequence(
                SequenceGenericScriptStatement::Create({create.ScriptKeyword("setCardIcon"),
                                                        create.Char('('),
                                                        create.ScriptLocalVarIntOrLiteral(),
                                                        create.Char(')')})); // setCardIcon '(' ((localVarInt '(' <var name> ')') | <card icon index>) ')'
            AddSequence(
                SequenceGenericScriptStatement::Create({create.ScriptKeyword("setCardTitle"),
                                                        create.Char('('),
                                                        create.ScriptLocalVarIntOrLiteral(),
                                                        create.Char(')')})); // setCardTitle '(' ((localVarInt '(' <var name> ')') | <card title index>) ')'
            AddSequence(SequenceGenericScriptStatement::Create(
            ...
            AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("setCardTitleNew"),
                                                                create.Char('('),
                                                                create.ScriptLocalVarIntOrLiteral(),
                                                                create.Char(','),
                                                                create.Or({
                                                                ...
                                                                create.Char(')')})); // setCardTitleNew '(' ((localVarInt '(' <var name> ')') | <card icon
                                                                                     // index>) ',' ((localVarInt '(' <var name> ')') | <is new>) ')'
            ...
            AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("purchasePrestigeTitle"),
                                                                create.Char('('),
                                                                create.ScriptText(),
                                                                create.Char(')')})); // purchasePrestigeTitle '(' <title name> ')'
            AddSequence(
                SequenceGenericScriptStatement::Create({create.ScriptKeyword("setProfileItemNew"),
                                                        create.Char('('),
                                                        create.ScriptText(),
                                                        create.Char(','),
                                                        create.ScriptLocalVarIntOrLiteral(),
                                                        create.Char(')')})); // setProfileItemNew '(' <item name> ',' (0|1|(localVarInt '(' <var name> ')')) ')'
            ...
            AddSequence(
                SequenceGenericScriptStatement::Create({create.ScriptKeyword("saveGameSetLocalBool"), create.ScriptText()})); // saveGameSetLocalBool <var name>
            ...
            AddSequence(
                SequenceGenericScriptStatement::Create({create.ScriptKeyword("setSaveExecOnSuccess"), create.ScriptText()})); // setSaveExecOnSuccess <command>
            ...
            AddSequence(SequenceGenericScriptStatement::Create({
                ...
                create.Char(')'),
            })); // playMenuVideo '(' <video name> ',' ((localVarInt '(' <var name> ')') | <offset>) ',' ((localVarBool '(' <var name> ')') | <maybe looping
                 // bool>) ')'
            AddSequence(SequenceGenericScriptStatement::Create({create.ScriptKeyword("setBackgroundVideo"),
                                                                create.Char('('),
                                                                create.ScriptText(),
                                                                create.Char(')')})); // setBackgroundVideo '(' <video name or empty string> ')'
            AddSequence(SequenceGenericScriptStatement::Create(
                {create.ScriptKeyword("clearEntitlementNew"), create.ScriptText()}));                            // clearEntitlementNew <entitlement name>
            ...
            AddSequence(
                SequenceGenericScriptStatement::Create({create.ScriptKeyword("anticheat_bancheck"), create.ScriptStrictNumeric()})); // anticheat_bancheck <num>
            ...
            AddSequence(
                SequenceUiScriptStatement::Create({create.ScriptKeyword("SwitchSegmentTransition"), create.ScriptStrictInt(), create.ScriptStrictInt()}));
            ...
            AddSequence(SequenceUiScriptStatement::Create({create.ScriptKeyword("Playlist"),
                                                           create.Or({
                                                               create.And({
