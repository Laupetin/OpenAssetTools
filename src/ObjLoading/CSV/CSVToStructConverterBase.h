...
class CSVToStructConverterBase
{
public:
    CSVToStructConverterBase(const InfoString& infoString,
                                    void* structure,
                                    ZoneScriptStrings& zoneScriptStrings,
                                    MemoryManager& memory,
                                    AssetCreationContext& context,
                                    GenericAssetRegistration& registration);
    virtual ~CSVToStructConverterBase() = default;
    CSVToStructConverterBase(const CSVToStructConverterBase& other) = delete;
    CSVToStructConverterBase(CSVToStructConverterBase&& other) noexcept = delete;
    CSVToStructConverterBase& operator=(const CSVToStructConverterBase& other) = delete;
    CSVToStructConverterBase& operator=(CSVToStructConverterBase&& other) noexcept = delete;
