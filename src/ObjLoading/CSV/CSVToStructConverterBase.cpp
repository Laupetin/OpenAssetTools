#include "CSVToStructConverterBase.h"
...
CSVToStructConverterBase::CSVToStructConverterBase(const InfoString& infoString,
                                                                 void* structure,
...
bool CSVToStructConverterBase::ParseAsArray(const std::string& value, std::vector<std::string>& valueArray)
{
    auto startPos = 0u;
...
bool CSVToStructConverterBase::ConvertString(const std::string& value, const size_t offset)
{
    *reinterpret_cast<const char**>(reinterpret_cast<uintptr_t>(m_structure) + offset) = m_memory.Dup(value.c_str());
    return true;
}

bool CSVToStructConverterBase::ConvertStringBuffer(const std::string& value, const size_t offset, const size_t bufferSize)
{
    strncpy(reinterpret_cast<char*>(reinterpret_cast<uintptr_t>(m_structure) + offset), value.c_str(), bufferSize);
    return true;
}

bool CSVToStructConverterBase::ConvertInt(const std::string& value, const size_t offset)
{
    char* endPtr;
...
bool CSVToStructConverterBase::ConvertUint(const std::string& value, const size_t offset)
{
    char* endPtr;
...
bool CSVToStructConverterBase::ConvertBool(const std::string& value, const size_t offset)
{
    char* endPtr;
...
bool CSVToStructConverterBase::ConvertQBoolean(const std::string& value, const size_t offset)
{
    char* endPtr;
    const auto intValue = strtol(value.c_str(), &endPtr, 0);
...
bool CSVToStructConverterBase::ConvertFloat(const std::string& value, const size_t offset)
{
    char* endPtr;
...
bool CSVToStructConverterBase::ConvertMilliseconds(const std::string& value, const size_t offset)
{
    char* endPtr;
...
bool CSVToStructConverterBase::ConvertScriptString(const std::string& value, const size_t offset)
{
...
bool CSVToStructConverterBase::ConvertEnumInt(
