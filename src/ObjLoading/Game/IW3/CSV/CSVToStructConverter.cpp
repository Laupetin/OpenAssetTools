#include "CSVToStructConverter.h"
...
CSVToStructConverter::CSVToStructConverter(const InfoString& infoString,
                                                         void* structure,
    ...
    : CSVToStructConverterBase(infoString, structure, zoneScriptStrings, memory, context, registration),
      m_fields(fields),
      m_field_count(fieldCount)
{
}

bool CSVToStructConverter::ConvertBaseField(const cspField_t& field, const std::string& value)
{
...
bool CSVToStructConverter::Convert()
{
