...
namespace
{
    ...
    public:
        ...
        AssetCreationResult CreateAsset(const std::string& assetName, AssetCreationContext& context) override
        {
            ...
            techniqueSet->worldVertFormat = (MaterialWorldVertexFormat)js["worldVertFormat"];
            ...
            for (int i = 0; i < 36; i++)
            {
                ...
                else
                {
                    ...
                    for (auto passIndex = 0u; passIndex < technique->passCount; passIndex++)
                    {
                        ...
                        currPass->precompiledIndex = (VertexShaderPrecompiledIndex)passJs["precompiledIndex"];
                        currPass->materialType = (MaterialType)passJs["materialType"];
