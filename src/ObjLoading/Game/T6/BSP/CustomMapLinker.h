...
namespace BSP
{
    ...
    public:
        ...
        bool linkCustomMap(BSPData* projInfo)
        {
    ...
    private:
        ...
        bool overwriteDrawData(BSPData* projInfo, GfxWorld* gfxWorld)
        {
        ...
        void overwriteMapSurfaces(BSPData* projInfo, GfxWorld* gfxWorld)
        {
        ...
        void overwriteGfxLights(GfxWorld* gfxWorld)
        {
            ...
            for (unsigned int i = 0; i < gfxWorld->primaryLightCount; i++)
            {
                ...
                gfxWorld->shadowGeom[i].sortedSurfIndex = new uint16_t[gfxWorld->surfaceCount];
                memset(gfxWorld->shadowGeom[i].sortedSurfIndex, 0, sizeof(uint16_t) * gfxWorld->surfaceCount);
            }
        ...
        void createGfxWorld(BSPData* projInfo)
        {
        ...
        void addXModelsToCollision(BSPData* projInfo, clipMap_t* clipMap)
        {
        ...
        void createPartitions(BSPData* projInfo, clipMap_t* clipMap)
        {
            ...
            {
                BSPSurface* currSurface = &projInfo->colWorld.surfaces[i];
        ...
        void createClipMap(BSPData* projInfo)
        {
        ...
        void createComWorld(BSPData* projInfo)
        {
        ...
        void createMapEnts(BSPData* projInfo)
        {
            ...
            const auto entFile = m_search_path.Open("BSP/entities.json");
            json entJs;
            if (!entFile.IsOpen())
            {
                printf("WARN: can't find entity json BSP/entities.json, using default entities\n");
            ...
            const auto spawnFile = m_search_path.Open("BSP/spawns.json");
            json spawnJs;
            if (!spawnFile.IsOpen())
            {
                printf("WARN: cant find BSP/spawns.json, setting spawns to 0 0 0\n");
        ...
        void createGameWorldMp(BSPData* projInfo)
        {
        ...
        void createSkinnedVerts(BSPData* projInfo)
        {
        ...
        void checkAndAddDefaultRequiredAssets(BSPData* projectInfo)
        {
