#include "LoaderAttachmentIW6.h"

#include "Game/IW6/IW6.h"
#include "Game/IW6/Weapon/JsonWeaponAttachment.h"
...
#define CONVERT_ATTRIBUTE(attributeClass, attributeName)                                                                                                       \
    ...
    {                                                                                                                                                          \
        ...
        bool CreateSoundFromJson(const std::string& assetName, snd_alias_list_t& sndAliasCustom, const WeaponAttachment& attachment) const
        {
            m_registration.AddIndirectAssetReference(m_context.LoadIndirectAssetReference<AssetSound>(assetName));
            sndAliasCustom.aliasName = m_memory.Dup(assetName.c_str());
...
{
    std::unique_ptr<AssetCreator<AssetAttachment>> CreateLoaderIW6(MemoryManager& memory, ISearchPath& searchPath)
    {
