...
namespace weapon
{
    std::unique_ptr<AssetCreator<AssetWeapon>> CreateGdtLoaderIW6(MemoryManager& memory, ISearchPath& searchPath, IGdtQueryable& gdt, Zone& zone)
    {
