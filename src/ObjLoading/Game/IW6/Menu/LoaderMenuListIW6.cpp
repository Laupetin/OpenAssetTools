#include "LoaderMenuListIW6.h"

#include "Game/IW6/IW6.h"
#include "Game/IW6/Menu/MenuConversionZoneStateIW6.h"
#include "Game/IW6/Menu/MenuConverterIW6.h"
...
namespace
{
    ...
    private:
        ...
        {
            menu::MenuFileReader reader(stream, menuFileName, menu::FeatureLevel::IW6, m_search_path);
...
namespace menu
{
    std::unique_ptr<AssetCreator<AssetMenuList>> CreateMenuListLoaderIW6(MemoryManager& memory, ISearchPath& searchPath)
    {
