#include "LoaderMaterialIW6.h"

#include "Game/IW6/IW6.h"
#include "Game/IW6/Material/JsonMaterialLoaderIW6.h"
...
namespace material
{
    std::unique_ptr<AssetCreator<AssetMaterial>> CreateLoaderIW6(MemoryManager& memory, ISearchPath& searchPath)
    {
