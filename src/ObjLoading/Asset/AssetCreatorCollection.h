...
public:
    ...
    AssetCreationResult
        CreateAsset(asset_type_t assetType, const std::string& assetName, ISearchPath& searchPath, MemoryManager& memory, AssetCreationContext& context) const;
    AssetCreationResult
        CreateDefaultAsset(asset_type_t assetType, const std::string& assetName, MemoryManager& memory, const AssetCreationContext& context) const;
