    ...
    private:
                                        ...
                                        const bool isSampler)
        {
            ...
            if (isSampler)
            {
                ...
                argValue.code_const_source.m_index = *maybeSamplerSource;
            }
            else
            {
                ...
                argValue.code_const_source.m_index = *maybeConstSource;
            }
            ...
            if (result.HasNextCapture(CAPTURE_CODE_INDEX))
            {
                ...
                size_t codeArraySize = state->m_code_source_infos.GetInfoForCodeConstSource(argValue.code_const_source.m_index)->arrayCount;
                ...
                argValue.code_const_source.m_index += static_cast<CommonCodeConstSource>(indexValue);
            }
            ...
            if (isSampler)
                ...
                shaderCreatorResult = state->m_shader_arg_creator.AcceptShaderConstantArgument(destination, argValue.code_const_source.m_index);
